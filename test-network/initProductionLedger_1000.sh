...
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "$ORDERER_CA" -C production-channel -n production 4 1 2 3 5 6 -c '{"Args":["CreateCottonBale","true","2024-07-01T10:00:10Z","","cottonbale_2","false","One bale of cotton; Staple length 34; Strength 29 g/tex; Micronaire 4.0; Color grade 41; Leaf grade 3-4; Uniformity 81%","Vadodara, Gujarat, India","Medium","480.00"]}'
...
check_status "Creating 37 rolls of unfinished fabric"
...
check_status "Creating 37 rolls of finished fabric"
