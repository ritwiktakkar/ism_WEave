...
# Add cotton yarn
# for i in {1..775}
for i in $(seq 1 $CONES_OF_YARN) # 775 cones of yarn
do
...
# yarn_list_1=$(generate_yarn_list 1 388)
...
# yarn_list_2=$(generate_yarn_list 389 775)
...
check_status "Creating 18 rolls of unfinished fabric"
